...
<main class="py-6 px-4 sm:p-6 md:py-10 md:px-8">
    <div class="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
        ...
        <div class="grid gap-4 col-start-1 col-end-3 row-start-1 sm:mb-6 sm:grid-cols-4 lg:gap-6 lg:col-start-2 lg:row-end-6 lg:row-span-6 lg:mb-0">
            <img src="https://concepto.de/wp-content/uploads/2018/09/Pintura-e1536849318148.jpg" alt="" class="w-full h-60 object-cover rounded-lg sm:h-52 sm:col-span-2 lg:col-span-full" loading="lazy">
            <img src="https://media.admagazine.com/photos/618a6acbcc7069ed5077ca7f/master/w_3000,h_2122,c_limit/68704.jpg" alt="" class="hidden w-full h-52 object-cover rounded-lg sm:block sm:col-span-2 md:col-span-1 lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy">
            <img src="https://1.bp.blogspot.com/-Qni8FLuEZ2Q/YHXxNFbPXII/AAAAAAAASOM/G4w3LGwqWfIbGASzJcvChB8x_EhKERlJACLcBGAsYHQ/s750/proceso-industrial-fabricacion-de-pinturas-pinturas-comerciales-envasadas.jpg" alt="" class="hidden w-full h-52 object-cover rounded-lg md:block lg:row-start-2 lg:col-span-2 lg:h-32" loading="lazy">
        </div>
